...
```{js fechas, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
// --------- DEFINIR FECHA ----------------------------------------
...
```{js visualizacion, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
...
```{js descarga, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
// ---------  DESCARGAR IMAGEN---------------------------
