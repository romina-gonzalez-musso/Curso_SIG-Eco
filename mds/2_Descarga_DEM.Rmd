...
```{js asset, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
// --------- TRAER EL ASSET ---------------------------
...
```{js metadata, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
// --------- VER METADATOS ---------------------------
...
```{js calculo1, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
...
```{js calculo2, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
...
```{js vis, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
...
### **6. Descargar**
```{js descargar, message=FALSE, warning=FALSE, paged.print=FALSE, results = FALSE}
// --------- DESCARGAR ---------------------------------------
